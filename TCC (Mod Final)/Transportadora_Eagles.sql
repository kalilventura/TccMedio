...
Create table DadosBackup(
CodDados int identity,
Data date not null,
Usuario varchar(15) foreign key references Usuario(Id_usuario)
Primary key(CodDados))

go

Insert into DadosBackup values('10-10-2015','Nivel5_1004')
...
Distancia_tot decimal(12,2) not null,
...
Veiculo varchar(7) foreign key references Veiculo(Placa),
Tipo int,
Fretamento int foreign key references Fretamento(Codigo_fretamento),
Primary key(Codigo_entrega))
go

--Insert into Entrega_retirada values('Rua Joaquim Coelho Freitas',248,'','Santo Agostinho',3,25,'','14401360','ASD5310',1),
--('Rua Doutor Cardoso de Almeida',1350,'','Centro',4,25,'','18600005','LKK5448',2,1)
...
Data date not null,
Distancia_tot decimal(10,2) not null,
Data_entrega date null,
Veiculo varchar(7) foreign key references Veiculo(Placa),
Codigo_cliente int foreign key
references Cliente(Codigo_cliente),
...
Insert into Venda values(2,2548468.9,'26/03/2015',1,'26/03/2015','PLK9642',2,5,1,1)
...
insert into Orcamento values (2,'1164642400','pepsicobrasil@pepsico.com',2073457.4,'26/03/2015','05/08/2015',2,'LKK5448',12,1,2)
...
Select * from Contas
Select * from DadosBackup
Select * from Entrega_retirada
