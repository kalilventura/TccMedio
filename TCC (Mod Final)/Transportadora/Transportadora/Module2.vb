Module Module2
    Public Sub fundo(ByRef tela As Control)
        ...
        For Each Objeto In tela.Controls
            ...
            If TypeOf Objeto Is System.Windows.Forms.MaskedTextBox Then
                ...
                If Objeto.BackColor.ToArgb = -1 Or Objeto.BackColor = Color.White Then
                    ...
                    AddHandler Objeto.GotFocus, AddressOf Mask_GotFocus
                    AddHandler Objeto.LostFocus, AddressOf Mask_LostFocus
                End If
            End If
        Next
    End Sub
    Public Sub Mask_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        'If TypeOf Objeto Is System.Windows.Forms.TextBox Then
        Dim Mask As MaskedTextBox = sender
        Mask.BackColor = Color.Lime
        'ElseIf TypeOf Objeto Is System.Windows.Forms.MaskedTextBox Then
        '    Dim Text As MaskedTextBox = sender
        '    Text.BackColor = Color.Lime
        'End If
    End Sub
    Public Sub Numeros_KeyPress(KeyAscii As Integer)
    ...
    End Sub
    Public Sub Mask_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        'If TypeOf Objeto Is System.Windows.Forms.TextBox Then
        Dim Mask As MaskedTextBox = sender
