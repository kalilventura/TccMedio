...
Public Class Venda4Destino2
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        If TextBox7.Text <> "" And TextBox8.Text <> "" And TextBox9.Text <> "" And TextBox11.Text <> "" And TextBox12.Text <> "" And TextBox13.Text <> "" Then
            ...
            '        .Connection = cn
            '        .CommandTimeout = 0
            '        .CommandText = "Select TOP 1 * from Entrega order by Codigo_entrega desc"
            '        .CommandType = CommandType.Text
            '    End With
            ...
            '        .Connection = cn
            '        .CommandTimeout = 0
            '        .CommandText = "insert into Entrega_retirada(Logradouro, Num, Complemento, Bairro, Cidade, UF, Ponto_ref, CEP, Veiculo, Tipo) values ('" & TextBox8.Text & " ', '" & TextBox7.Text & "', '" & TextBox10.Text & "', '" & TextBox9.Text & "' , '" & TextBox11.Text & "', '" & TextBox12.Text & "', '" & TextBox3.Text & "', '" & TextBox13.Text & "', '" & Venda2DadosCarga.ListBox1.SelectedItem & "',  2 )"
            '        .CommandType = CommandType.Text
            '    End With
